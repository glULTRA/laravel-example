...
{{-- <div class="justify-center flex">
    <div class="w-8/12 bg-main-500 py-4  mt-4 rounded px-4 text-white   ">
        But authenticate user is {{ auth()->user()->username }}
    </div>
</div> --}}
<div class="">
    <div class="max-w-sm bg-main-500 py-5 h-auto mx-auto my-20 rounded-md overflow-hidden shadow-lg">
      <img class="object-cover rounded-full h-36 w-36 mx-auto m-1 p-1 border-4 border-main-600" src="https://images.unsplash.com/photo-1477118476589-bff2c5c4cfbb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=200&q=200" alt="Human Picture by Ike louie Natividad" />
      <div class="px-6 py-4">
        <div class="flex flex-col">
          <div class="font-bold text-xl text-center  text-main-50 font-mono hover:cursor-pointer">{{$user->name}}</div>
          <p class="text-main-50 text-sm text-center font-mono">{{$user->username}}</p>
        </div>
        <div class="flex flex-row justify-center font-semibold mx-auto my-4">
          <div class="my-auto text-white bg-main-600 hover:bg-main-800 hover:cursor-pointer rounded-3xl py-2 px-4 mx-2">Add friend</div>
          <div class="my-auto text-gray-800 py-1 px-4 border-2 border-main-600 hover:bg-main-800 hover:cursor-pointer hover:text-white rounded-3xl mx-2">Message</div>
        </div>
      </div>
      ...
      <div class="bg-main-600  text-white mt-5 px-6 pt-4 pb-5 flex flex-row justify-center">
